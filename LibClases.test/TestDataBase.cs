...
namespace LibClases.test
{
    ...
    public class TestDataBase
    {
        ...
        public void TestMethod1()
        {
            ...
            //Prueba getUsuarios
            Assert.AreEqual(db.getUsuarios().Count, 10);
            ...
            Assert.AreEqual(db.getEncuestas().Count, 10);
            ...
            Assert.AreEqual(db.getEncuestas().Count, 11);
            
            //Prueba getActivas y getNoActivas
            Assert.AreEqual(db.getActivas().Count, 5);
            Assert.AreEqual(db.getNoActivas().Count, 6);
